...
const LogIn = () => {
    ...
    const handleValidateCaptcha = () => {
        const userValidateCaptcha = captchaRef.current.value; 

        if(validateCaptcha(userValidateCaptcha)){
            setDisabled(false)
        }
        else{
            setDisabled(true)
                ...
                <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-gradient-to-r from-rose-100 via-rose-100 to-rose-50"  >
                    ...
                    <div className="w-full py-6 z-20 ">
                        ...
                        <form onSubmit={handleLogin} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                            ...
                            <div className="pb-2 pt-4">
                                <div style={{ color: "#e07626" }}>
                                    <LoadCanvasTemplate ></LoadCanvasTemplate>
                                </div>
                                <input type="text" ref={captchaRef} name="captcha" id="captcha" placeholder="Type the captcha above" className="block w-full p-4 text-lg rounded-sm bg-gradient-to-r from-rose-100 via-rose-100 to-rose-50" style={{ border: "1px solid #e07626", color: "#e07626" }} />
                            <abbr onClick={handleValidateCaptcha} className='cursor-pointer' >Validate</abbr>
                            </div>
